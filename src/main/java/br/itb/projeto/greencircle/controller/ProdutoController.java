...
import br.itb.projeto.greencircle.service.CategoriaService;
import br.itb.projeto.greencircle.service.ProdutoService;
...
//		}
	...
	public void showImage(@PathVariable("id") long id, 
			HttpServletResponse response, Produto produto)
